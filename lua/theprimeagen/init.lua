...
conkc_test_path = '\\\\qa-web\\PDS\\vista\\conkc\\Web\\'
pacy_test_path = '\\\\hostweb2\\PDS\\vista\\PACY\\PACYTEST\\Web\\'
kcdc_test_path = '\\\\pds-web02\\PDS\\Vista\\KCDC\\KCDCTEST\\Web\\'
bhs_test_path = '\\\\hostweb2\\PDS\\Vista\\BHS\\BHSDEVL\\Web\\'
cpu_test_path = '\\\\pds-web03\\PDS\\Vista\\CPU\\CPUTEST\\Web\\'
remote_path = pacy_test_path
...
function TestPath()
    ...
    print(destination, file_exists and "exists" or "does not exist")end
